...
class Ui_Layout(object):
    ...
    def retranslateUi(self, Layout):
        ...
        self.comboBox.setItemText(7, _translate("Layout", "0x8: Begin Keypress Conditional Block"))
        self.comboBox.setItemText(8, _translate("Layout", "0x9: Perform Arithmetic"))
        self.comboBox.setItemText(9, _translate("Layout", "0xA: Store Register to Memory Address"))
